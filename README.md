...
**GPLv3** — free software. Forks and redistributions are welcome, but you **must keep the author attribution (KeilerHirsch)** and the same license. See [LICENSE](LICENSE).
